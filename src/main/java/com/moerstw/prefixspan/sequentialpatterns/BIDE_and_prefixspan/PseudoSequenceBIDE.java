...
//					if(listPositions.size()+ listPositionsTotal.size()	== getItemOccurencesTotalCount(prefix))  // si on a trouve tout le prefix
//					{
...
//	}
	 ...
	 * @param i : le ieme element du prefixe.
...
//			pseudo.toString();
	 ...
	 * @param i : the ieme element of the prefix.
